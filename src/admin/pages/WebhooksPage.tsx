...
export function WebhooksPage() {
  return (
    <AdminLayout title="Webhooks" actions={<></>}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: 400 }}>
        <div style={{ textAlign: 'center', maxWidth: 420, fontFamily: FONT }}>
          ...
          <div style={{ fontSize: 14, color: '#64748B', lineHeight: 1.6 }}>
            This module has been made unavailable by <strong>Ahmad</strong> — Webhooks will be configured in a later phase once the system is live and external integrations are needed.
          </div>
        </div>
      </div>
    </AdminLayout>
